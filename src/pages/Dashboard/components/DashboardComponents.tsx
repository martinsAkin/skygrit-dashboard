...
export const DashboardAnalytics = ({
 ...
 return (
  <div className="border-1 border-gray-300 rounded-[8px] px-[25px] py-[12px] flex-1 flex flex-col gap-2">
   ...
   <span className="text-[12px] text-[#6B7280]">
    <span className="mr-1.9" style={{ color: metricColor }}>
     {metrics}
    </span>{" "}
    from last {duration}
   </span>
 ...
 return (
  <div className="flex gap-3 mt-2">
   ...
   <ul className="list-none text-[13px]">
    <li className="font-semibold text-[#111827] text-[12px] mb-1">{heading}</li>
