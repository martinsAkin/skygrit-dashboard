...
const AddRoleUserMgt = ({onCancel}: ModulesProps) => {
  return (
    <div className='fixed inset-0 bg-black/50 flex justify-center items-center z-50'>
     <div className='bg-white rounded-lg py-2.5 px-5 w-[30rem]'>
       <div className='mb-2'>
        <h1 className='text-[25px]'>Add Role</h1>
        <span className='text-[13px]'>Provide required information to create a new wole</span>
       </div>
       <form action="" method="post">
         <div className='addUserForm-div'>
            <label htmlFor="role_name" className="addUserForm-label">Role Name: *</label>
