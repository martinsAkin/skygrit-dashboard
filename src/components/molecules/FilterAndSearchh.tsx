      ...
      <div className="flex flex-row gap-6">
        ...
        <div className="flex flex-row px-6 py-2 gap-4 bg-[#E5E7EB] border-[1px] border-[#DCDEE6] rounded-[4px] items-center">
          ...
          <input
            ...
            type="text"
            name="search"
            placeholder="Search with templates"
            value={searchTerm}
        ...
        <div className="relative">
          ...
          >
            <img className="w-[20px] h-[20px]" src={filterIcon} alt="" />
...
export default FilterAndSearchh;
